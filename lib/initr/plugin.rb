# Copy if redmine/lib/redmine/plugin.rb
# can not use inheritance because use of cattr_accessor
...
module Initr #:nodoc:
  ...
  class Plugin
    ...
    def migrate(version = nil)
      ...
      Initr::Plugin::Migrator.migrate_plugin(self, version)
    end
